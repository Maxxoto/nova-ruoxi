...
| Code generation       | DeepSeek V3                   | — (OpenRouter)             |
| Planning & reasoning  | Gemini 2.5 Flash              | — (OpenRouter/Google AI Studio) |
...
| Embedding DB     | ChromaDB (for general purpose) / Qdrant (for RAG) |
